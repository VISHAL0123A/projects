...
data = pd.read_csv("C:/Users/VISHAL/Downloads/Screentime-App-Details.csv")
print(data.head())
...
#Now we see whether the dataset has any null values or not:
...
#Screen Time Analysis is the task of analyzing and creating a report on which applications and websites are used by the user for how much time. I hope you liked this article on Screen Time Analysis using Python. Feel free to ask valuable questions in the comments section below.
